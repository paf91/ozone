...
/**
 * Authentication and authorization hook for S3 Gateway requests.
 */
public interface S3GatewayAuthProvider {
  S3Principal authenticate(ContainerRequestContext context,
